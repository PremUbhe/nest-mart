  ...
  return (
    <>
      ...
      <section className='container pb-20'>
        <div className="flex flex-wrap">
          <div className="w-full xl:w-7/12 lg:w-6/12">
            <Image src={performanceImg} className='w-full h-auto' alt='performance Image'></Image>
          </div>
          <div className="w-full xl:w-5/12 lg:w-6/12 p-4 ms-5">
            <h5 className='text-2xl text-gray font-semibold'>Our performance</h5>
            <h2 className='text-3xl md:text-5xl text-blue font-bold mb-5'>Your Partner for e-commerce grocery solution</h2>
